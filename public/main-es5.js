...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          "modules-design-design-module").then(__webpack_require__.bind(null,
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        value: function deleteRecord(table, id, data) {
          ...
          this.feathers.service('api/deleted-records').create(recordData); // delete the record
  ...
  function srcAppModulesCoreServicesFeathersServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Feathers = /*#__PURE__*/function () {
      function Feathers() {
        ...
        this._socket = socket_io_client__WEBPACK_IMPORTED_MODULE_2__('http://localhost:3030'); //private _socket = io('https://stacks.coretech.chst.io');      // init feathers
  ...
  function srcAppModulesSharedLayoutLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function LayoutComponent_clr_dropdown_menu_31_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LayoutComponent_clr_dropdown_menu_31_Template_a_click_5_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);
  ...
  function srcAppModulesSharedRecordsListViewRecordsListViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _page_loading_page_loading_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _shared_record_details_shared_record_details_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    function RecordsListViewComponent_span_1_clr_datagrid_1_clr_dg_detail_14_clr_dg_detail_header_1_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var detail_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function RecordsListViewComponent_span_1_form_7_span_1_clr_input_container_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecordsListViewComponent_span_1_form_7_span_1_clr_input_container_1_Template_input_ngModelChange_3_listener($event) {
          ...
          var f_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);

          return ctx_r32.newRecord[f_r27.name] = $event;
        });
    ...
    function RecordsListViewComponent_span_1_form_7_span_1_clr_textarea_container_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecordsListViewComponent_span_1_form_7_span_1_clr_textarea_container_2_Template_textarea_ngModelChange_3_listener($event) {
          ...
          return ctx_r36.newRecord[f_r27.name] = $event;
        });
    ...
    function RecordsListViewComponent_span_1_form_7_span_1_clr_select_container_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecordsListViewComponent_span_1_form_7_span_1_clr_select_container_3_Template_select_ngModelChange_3_listener($event) {
          ...
          return ctx_r40.newRecord[f_r27.name] = $event;
        });
    ...
    function RecordsListViewComponent_span_1_form_7_span_1_clr_password_container_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecordsListViewComponent_span_1_form_7_span_1_clr_password_container_4_Template_input_ngModelChange_3_listener($event) {
          ...
          return ctx_r44.newRecord[f_r27.name] = $event;
        });
    ...
    function RecordsListViewComponent_span_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clrModalOpenChange", function RecordsListViewComponent_span_1_Template_clr_modal_clrModalOpenChange_3_listener($event) {
          ...
          return ctx_r48.showCreateRecord = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RecordsListViewComponent_span_1_Template_button_click_9_listener() {
          ...
          return ctx_r50.showCreateRecord = false;
        });
    ...
    var RecordsListViewComponent = /*#__PURE__*/function () {
      function RecordsListViewComponent(dataService) {
      ...
      _createClass(RecordsListViewComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          console.log('\n\n FILTER ON PARENT');
          console.log(this.filterOnParent); // console.log(this.filterOnParent)
          // console.log('\n\n ---- PARENT ID ----');
          ...
          this.recordsLoaded = this.records$.subscribe(function () {
        ...
        value: function createRecord() {
          ...
          for (var f in this.currentTable.addRecordForm.fields) {
            var req = this.currentTable.addRecordForm.fields[f].required;
            var length = this.newRecord[this.currentTable.addRecordForm.fields[f].name].length;

            if (req && length == 0) {
              errors.push("".concat(this.currentTable.addRecordForm.fields[f].label, " is a required field"));
            }
          }
          ...
          if (errors.length == 0) {
            ...
            this.dataService.createRecord(this.currentTable.servicePath, this.newRecord).then(function (data) {
              ...
              // }
              _this6.addRecord = false;
              _this6.showCreateRecord = false;
            })["catch"](function (error) {});
          } else {
    ...
    RecordsListViewComponent.ɵfac = function RecordsListViewComponent_Factory(t) {
      return new (t || RecordsListViewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]));
    };
  ...
  function srcAppModulesSharedSharedRecordDetailsSharedRecordDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SharedRecordDetailsComponent_clr_tab_1_clr_tab_content_3_div_4_Template(rf, ctx) {
      if (rf & 1) {
  ...
  function srcAppModulesSharedSharedRecordEditSharedRecordEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SharedRecordEditComponent_form_2_span_1_clr_input_container_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SharedRecordEditComponent_form_2_span_1_clr_input_container_1_Template_input_ngModelChange_3_listener($event) {
          ...
          return ctx_r9.record[f_r4.name] = $event;
        });
    ...
    function SharedRecordEditComponent_form_2_span_1_clr_textarea_container_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SharedRecordEditComponent_form_2_span_1_clr_textarea_container_2_Template_textarea_ngModelChange_3_listener($event) {
          ...
          return ctx_r13.record[f_r4.name] = $event;
        });
    ...
    function SharedRecordEditComponent_form_2_span_1_clr_select_container_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SharedRecordEditComponent_form_2_span_1_clr_select_container_3_Template_select_ngModelChange_3_listener($event) {
          ...
          return ctx_r17.record[f_r4.name] = $event;
        });
    ...
    function SharedRecordEditComponent_form_2_span_1_clr_password_container_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SharedRecordEditComponent_form_2_span_1_clr_password_container_4_Template_input_ngModelChange_3_listener($event) {
          ...
          return ctx_r21.record[f_r4.name] = $event;
        });
      ...
      _createClass(SharedRecordEditComponent, [{
        ...
        value: function updateRecord() {
          ...
          this.dataService.updateRecord(this.table.servicePath, this.record._id, this.record).then(function () {
            _this7.saveRecordSuccess = true;
            setTimeout(function () {
              _this7.saveRecordSuccess = false;
            }, 3000);
          })["catch"](function () {
            _this7.saveRecordError = true;
            setTimeout(function () {
              _this7.saveRecordError = false;
            }, 3000);
          });
        }
      }, {
  ...
  function srcAppModulesSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _alert_alert_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
